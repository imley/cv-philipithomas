...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Jiang Lei Curriculum Vitae</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Curriculum Vitae for Jiang Lei">
    <meta name="author" content="Jiang Lei">
	...
	<script type="text/javascript">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-8371634-15']);
	  _gaq.push(['_setDomainName', 'cv.imley.net']);
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <li><a href="http://imley.net/" target="_blank>">Homepage</a></li>
              <li class="dropdown ">
                   ...
                   <ul class="dropdown-menu ">
                                <li><a href="http://cn.linkedin.com/pub/lei-jiang/21/989/626/" target="_blank">LinkedIn</a></li>
                <li><a href="http://github.com/imley" target="_blank">Github</a></li>
                <li><a href="http://twitter.com/imley" target="_blank"><i class="icon-off"></i> Sign Out</a></li>
            </ul>
               </li>
...
-->
	...
	<div class="span12">
      ...
      <h1 style="padding: 10px 0px; text-align: center; font-size: 60px; line-height: 70px; text-transform: lowercase">Jiang Lei</h1>
	<span class="" style="text-align: center;"> 
		<address>
		<a href="http://imley.net/" target="_blank">imley.net</a><br />
		<a href="mailto:#">ley@imley.net</a><br />
		<a>+86.18600062203</a>
		</address>
	</span>
		</div>
...
iprogram('NoSQL Databases','65'); 
iprogram('Javascript','30');
iprogram('Git','60');
iprogram('Unix System Administration','70');
...
<div class="span4">
	<div class="well">
		...
		<a class="pull-right btn btn-small btn-inverse" href="http://github.com/imley">Github Profile <i class="icon-arrow-right icon-white"></i></a><br />
	</div>
</div>
</div>
	...
	<div class="well">
		...
		<a class="pull-right btn btn-small btn-inverse" href="http://imley.net/press">View Full Press <i class="icon-arrow-right icon-white"></I></a><br />
	</div>
	</div>
	</div>
	...
	<hr />
      <p style="text-align: center">&copy; <a href="http://imley.net">Jiang Lei</a> 2012</p>
      <p style="text-align: center"><strong>forked</strong> from the CV of <a href="http://www.philipithomas.com">Philip I. Thomas</a></p>
      </footer>      
